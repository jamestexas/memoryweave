...
from memoryweave.evaluation.synthetic.benchmark import SyntheticBenchmark, BenchmarkConfig
...
def main():
    ...
    parser.add_argument(
        "--num-queries", type=int, default=20, help="Number of test queries to run"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--complexity", type=str, default="medium", 
    ...
    parser.add_argument(
        "--save-dataset", type=str, default="datasets/semantic_dataset.json", 
        help="Path to save generated dataset"
    )
    parser.add_argument(
        "--save-results", type=str, default="semantic_benchmark_results.json", 
    ...
    if args.dataset and os.path.exists(args.dataset):
        ...
        logger.info(f"Generating semantic dataset with {args.num_memories} memories and {args.num_queries} queries")
    ...
    logger.info(f"Visualization saved to semantic_benchmark_results.png")
