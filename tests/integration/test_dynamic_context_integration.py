...
class TestDynamicContextIntegration:
    ...
    def test_pipeline_integration(self):
        ...
        results = self.retrieval_strategy.retrieve(
            combined_context["query_embedding"], 
            top_k=5, 
    ...
    def test_large_memory_adaptations(self):
        ...
        regular_results = large_strategy.retrieve(
            query_embedding,
            top_k=5,
        ...
        adapted_results = large_strategy.retrieve(
            query_embedding,
            top_k=5,
    ...
    def test_adaptation_affects_weights(self):
        ...
        assert self.retrieval_strategy.temporal_weight > original_temporal, "Temporal weight should increase for temporal queries"
