...
class PersonalAttributeManagerTest(unittest.TestCase):
    ...
    def test_demographic_extraction(self):
        ...
        self.assertEqual(result["personal_attributes"]["demographics"]["occupation"], "software engineer")
    ...
    def test_query_processing(self):
        ...
        self.assertIn("relevant_attributes", result)
        self.assertTrue(any(key.startswith("demographic_") for key in result["relevant_attributes"]))
    ...
    def test_attribute_update(self):
        ...
        self.assertEqual(
            self.attribute_manager.personal_attributes["preferences"]["color"],
            "green"
        )
