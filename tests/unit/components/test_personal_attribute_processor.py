...
class PersonalAttributeProcessorTest(unittest.TestCase):
    ...
    def test_attribute_boost(self):
        ...
        # Sample results
        test_results = [
            {"content": "Blue is the color of the sky.", "relevance_score": 0.5, "id": "mem1"},
            {"content": "Red is a vibrant color.", "relevance_score": 0.6, "id": "mem2"},
        ]

        # Process results with the processor
        processed_results = self.processor.process_results(test_results, query, attribute_context)
    ...
    def test_no_relevant_attributes(self):
        ...
        # Sample results
        test_results = [
            {"content": "Machine learning is a branch of AI.", "relevance_score": 0.7, "id": "mem1"}
        ]
