...
class RetrievalStrategiesTest(unittest.TestCase):
    ...
    def test_similarity_retrieval(self):
        ...
        # Retrieve memories
        results = self.similarity_strategy.retrieve(
            query_embedding, 3, {"memory": self.memory}
        )
    ...
    def test_temporal_retrieval(self):
        ...
        # Retrieve memories
        results = self.temporal_strategy.retrieve(
            query_embedding, 3, {"memory": self.memory}
        )
    ...
    def test_hybrid_retrieval(self):
        ...
        # Retrieve memories
        results = self.hybrid_strategy.retrieve(
            query_embedding, 3, {"memory": self.memory}
        )
    ...
    def test_confidence_threshold(self):
        ...
        query_embedding = -1 * self.memory.memory_embeddings[0]  # Opposite vector will have negative similarity
        query_embedding = query_embedding / np.linalg.norm(query_embedding)
