...
def format_memories(memories):
    ...
    if formatted:
        return "RELEVANT MEMORIES:\n" + "\n".join(formatted) + "\n\nPlease use these memories to answer the current question."
...
def main():
    ...
    try:
        ...
        test_conversation = [
            ...
            "I like to hike in the mountains on weekends. Do you enjoy outdoor activities?",
            "I'm thinking of painting my room. What color would you recommend?",
            "Tell me about a good beginner hike near Seattle.",
            "Actually, I'm reconsidering the painting project. What was my favorite color again?",
        ]
        ...
        for i, query in enumerate(test_conversation):
            ...
            if i > 0:
                ...
                for mem in memories[:2]:  # Show top 2
                    # ContextualRetriever.retrieve_for_context returns dictionaries
                    print(
