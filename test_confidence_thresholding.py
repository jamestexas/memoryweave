...
def generate_test_data():
    ...
    python_memories = [
        {"text": "Python is a high-level programming language known for readability and simplicity.", "relevance": "high"},
        {"text": "Python supports multiple programming paradigms including procedural and object-oriented.", "relevance": "high"},
        {"text": "Python has a large standard library and active community support.", "relevance": "high"},
        {"text": "Python's syntax allows programmers to express concepts in fewer lines of code.", "relevance": "high"},
        {"text": "Python is commonly used for web development, data analysis, and artificial intelligence.", "relevance": "medium"},
        {"text": "Python was created by Guido van Rossum in the late 1980s.", "relevance": "medium"},
        {"text": "Python is named after the British comedy group Monty Python.", "relevance": "low"},
        {"text": "Python is one of many programming languages used in software development.", "relevance": "low"},
    ]
    
    # Machine learning memories
    ml_memories = [
        {"text": "Machine learning is a subset of artificial intelligence focused on data-based learning.", "relevance": "high"},
        {"text": "Neural networks are composed of layers of interconnected nodes.", "relevance": "high"},
        {"text": "Deep learning uses multiple layers of neural networks for complex pattern recognition.", "relevance": "high"},
        {"text": "Supervised learning requires labeled training data to make predictions.", "relevance": "high"},
        {"text": "Machine learning algorithms improve through experience without explicit programming.", "relevance": "medium"},
        {"text": "Reinforcement learning involves agents learning through trial and error.", "relevance": "medium"},
        {"text": "The term 'machine learning' was coined by Arthur Samuel in 1959.", "relevance": "low"},
        {"text": "Machine learning competitions are often hosted on platforms like Kaggle.", "relevance": "low"},
    ]
    
    # Travel memories (unrelated to programming/ML)
    travel_memories = [
        {"text": "Paris is known as the City of Light and is famous for the Eiffel Tower.", "relevance": "unrelated"},
        {"text": "Japan's cherry blossom season typically occurs in spring.", "relevance": "unrelated"},
        {"text": "The Great Barrier Reef in Australia is the world's largest coral reef system.", "relevance": "unrelated"},
...
def test_confidence_thresholding():
        ...
        for threshold in thresholds:
            ...
            if results:
                for idx, score, metadata in results:
                    ...
                    console.print(f"  [{category}:{relevance}] {metadata.get('text', '')[:50]}... (Score: {score:.3f})")
    ...
    console.print("[success]Precision chart saved as 'confidence_threshold_precision.png'[/success]")
