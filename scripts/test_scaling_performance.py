...
def test_scaling_performance(embedding_model, memory_sizes=[100, 500, 1000, 2000, 5000]):
    ...
    for size in memory_sizes:
        ...
        print(
            f"  Standard:  Precision={standard_performance['precision']:.3f}, Recall={standard_performance['recall']:.3f}, F1={standard_performance['f1']:.3f}, Time={standard_performance['avg_retrieval_time']:.3f}s"
        )
        print(
            f"  Optimized: Precision={optimized_performance['precision']:.3f}, Recall={optimized_performance['recall']:.3f}, F1={optimized_performance['f1']:.3f}, Time={optimized_performance['avg_retrieval_time']:.3f}s"
        )
...
def plot_scaling_results(results):
    ...
    plt.subplot(2, 2, 2)
    plt.plot(
        sizes, [results[size]["standard"]["precision"] for size in sizes], "b-o", label="Standard"
    )
    plt.plot(
        sizes, [results[size]["optimized"]["precision"] for size in sizes], "r-o", label="Optimized"
    )
    plt.xlabel("Memory Size")
    ...
    plt.subplot(2, 2, 3)
    plt.plot(
        sizes, [results[size]["standard"]["recall"] for size in sizes], "b-o", label="Standard"
    )
    plt.plot(
        sizes, [results[size]["optimized"]["recall"] for size in sizes], "r-o", label="Optimized"
    )
    plt.xlabel("Memory Size")
    plt.ylabel("Recall")
    ...
    plt.plot(
        sizes,
        [results[size]["standard"]["avg_retrieval_time"] for size in sizes],
        "b-o",
        label="Standard",
    )
    plt.plot(
        sizes,
        [results[size]["optimized"]["avg_retrieval_time"] for size in sizes],
        "r-o",
        label="Optimized",
    )
    plt.xlabel("Memory Size")
